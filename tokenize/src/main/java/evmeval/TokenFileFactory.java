 ...
 * @author Jun Araki
 */
public class TokenFileFactory {

  private static final String CLASS_NAME = TokenFileFactory.class.getCanonicalName();
  ...
  private static final String OUTPUT_FILE_EXTENSION = "tkn";
   ...
   */
  public TokenFileFactory(String separatorChars) {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      TokenFileFactory factory = new TokenFileFactory(separatorChars);
