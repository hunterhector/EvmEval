...
./scorer_v1.1.py -g example_data/gold.tbf -s example_data/sample_system_A.tbf -d example_data/A_out -t example_data/tkn/ -o example_data/perfect_score -w -b
echo "Stored score report at example_data/prefect_score\n"
echo "Evaluating system B, with one file missed\n"
./scorer_v1.1.py -g example_data/gold.tbf -s example_data/sample_system_B.tbf -d example_data/B_out -t example_data/tkn/ -o example_data/one_miss_score -w -b
