...
output_tbf_filename=gold
output_tbf_basename=data/private/conversion_test/$output_tbf_filename
...
python ./validator.py -t "$token_table_dir" -s "$output_tbf_basename"".tbf"
echo "Validation done, see log at : "$output_tbf_filename".tbf.errlog"
